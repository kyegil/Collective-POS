...
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
	...
	<script language="JavaScript" type="text/javascript" src="<?=$this->http_host;?>/plugins/GroupSummary.js"></script>
	<script language="JavaScript" type="text/javascript" src="<?=$this->http_host;?>/plugins/fellesfunksjoner.js"></script>
...
<?endif?>
	<script language="JavaScript" type="text/javascript" src="index.php?docu=_shared&trader=<?=$_GET['trader']?>"></script>
